                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="{{route('login-submit')}}">
                                        @csrf
                                        <div class="form-head">
                                            <a href="{{route('login')}}" class="logo"><img src="{{asset('admin/assets/images/color_logo_no_background.svg')}}" class="img-fluid" alt="logo"></a>
                                        </div>
                                        <h4 class="text-primary mt-4 mb-4">Log in !</h4>
                                        ...
                                        <div class="form-group mb-4 pos-relative">
                                            ...
                                            <span toggle="#confirm_password" class="fa fa-fw fa-eye-slash p-toggle-password icon-password"></span>
                                            @error('password')
                                                <div class="invalid-feedback" role="alert">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="d-grid mb-4">
                                            <button class="btn btn-success  font-18" type="submit">Log in</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
